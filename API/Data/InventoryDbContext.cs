...
public partial class InventoryDbContext : DbContext
{
    ...
    public virtual DbSet<SupplierToCategory> SupplierToCategory { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SupplierToCategory>(entity =>
        {
            ...
            entity.HasOne(d => d.CategoryCodeNavigation).WithMany(p => p.SupplierToCategory)
                .HasForeignKey(d => d.CategoryCode)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__SupplierT__Categ__339FAB6E");

            entity.HasOne(d => d.Supplier).WithMany(p => p.SupplierToCategory)
