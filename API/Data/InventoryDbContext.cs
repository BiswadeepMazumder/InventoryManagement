...
public partial class InventoryDbContext : DbContext
{
    ...
    //         => optionsBuilder.UseSqlServer("Server=tcp:inventorydbservercsu.database.windows.net,1433;Initial Catalog=InventoryDB;Persist Security Info=False;User ID=Brian;Password=Biswa_2860920;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
     ...
     protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            ...
            // export CONNECTION_STRING="Server=tcp:inventorydbservercsu.database.windows.net,1433;Initial Catalog=InventoryDB;Persist Security Info=False;User ID=Brian;Password={888888};MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"
